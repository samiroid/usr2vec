...
if __name__ == "__main__":
	...
	train_path, stuff_pickle, user_embs, n_jobs = sys.argv[1:]
	print "Loading data"	
	...
	for e in xrange(epochs):	
		...
		while not done:
			...
			# set_trace()
			# res = [stream_train_user(i,sample) for i,sample in enumerate(current_samples)]
			res = Parallel(n_jobs=n_jobs)(delayed(stream_train_user)(i, sample) 
